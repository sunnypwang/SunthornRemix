function predict(wak,method) {
    ...
    if (this.readyState == 4 && this.status == 200) {
        document.getElementById("prediction_wrapper").classList.remove('loader');
    ...
    url = "http://35.234.33.177:3000/predict?method=" + method + "&tok=" + document.getElementById("word").value + "&wak=" + wak + "&mobile=" + isMobile
